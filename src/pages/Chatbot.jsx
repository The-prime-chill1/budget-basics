...
import { getOrCreateStudentSession, setStudentName } from '../utils/userSession';
...
export default function Chatbot() {
 ...
 'sup', 'yo', 'howdy', 'namaste', 'namaskar', 'hola', 'bonjour', 'salut',
 ...
 const isIdentityIntent = (norm) => {
 const idPhrases = [
 'who am i', 'what is my name', 'whats my name', 'what is my id',
 'whats my id', 'my id', 'who is chatting', 'do you know who i am',
 'do you know me', 'do you recognize me', 'my student id',
 'tell me my id', 'tell me my name', 'who am i chatting with'
 ];
 return idPhrases.some((phrase) => norm === phrase || norm.includes(phrase));
 };

 const isNameDeclarationIntent = (norm) => {
 return (
 norm.startsWith('my name is ') ||
 norm.startsWith('i am ') ||
 norm.startsWith('call me ') ||
 norm.startsWith('name is ')
 );
 };
 ...
 'en-GB': `Good afternoon${studentGreetingTarget}! How is your day going? Hope your classes and routine are running smoothly.\n\nWhat can I help you calculate or navigate with your allowance this afternoon?`,
 'en-US': `Good afternoon${studentGreetingTarget}! How is your day going? Hope your classes and day are going smoothly.\n\nWhat can I help you calculate or navigate with your budget this afternoon?`,
 'en-IN': `Namaste${studentGreetingTarget}! Dopahar kaisi chal rahi hai? Ummeed hai sab theek hoga.\n\nAaj bachat ya allowance ke baare me kya jaanna chahte hain?`,
 'es-ES': `¡Buenas tardes${studentGreetingTarget}! ¿Cómo va tu día? Espero que las clases y todo vayan genial.\n\n¿En qué te puedo ayudar con tu dinero hoy?`,
 'fr-FR': `Bon après-midi${studentGreetingTarget} ! Comment se passe votre journée ? J'espère que tout se déroule au mieux.\n\nQue puis-je faire pour vous aider avec votre budget cet après-midi ?`,
 'ar-SA': `مساء الخير${session?.name ? ` يا **${session.name}**` : ''}! كيف يسير يومك الدراسي؟ أتمنى أن تكون بأفضل حال.\n\nكيف يمكنني مساعدتك في إدارة مصروفك اليوم؟`
 };
 return {
 ...
 return {
 answer:
 "** How We Built BudgetBasics & Our Technology Stack:**\n\n" +
 ...
 return {
 answer:
 "**Enioluwafe Gbadamosi — Main Structure & Integration** \n\n" +
 ...
 "• **Enioluwafe Gbadamosi — Main Structure**\n" +
 ...
 "• **Needs vs. Wants**: Interactive sorting activity with real-time feedback and our **48-Hour Purchase Delay Guide** to stop buyer's remorse.\n" +
 ...
 "• **Infographics Gallery**: Budget cycles and saving challenges, with audio soundbites, captions, alt text, and topic filters.\n" +
 ...
 return {
 answer:
 "** Needs vs. Wants Filter (Built by Hamid)**\n\n" +
 ...
 return {
 answer:
 "** Infographics Gallery & Audio Soundbites**\n\n" +
 ...
 return (
 "**I am an educational budgeting assistant focused on student personal finance.**\n\n" +
 "I can help you with core financial learning topics:\n" +
 "• **What is a need vs. a want?** (Sorting essentials from lifestyle expenses)\n" +
 "• **How much should I save?** (50/30/20 rule and emergency cushion guidelines)\n" +
 "• **How do I avoid overspending?** (Practical tricks to stop impulse buys)\n" +
 "• **Surviving when broke** (Immediate step-by-step zero-cash triage)\n" +
 "• **Campus allowance planning** (Allocating your stipend across the semester)\n\n" +
 "You can also ask about the project, why we built it, our team, or how it works!\n\n" +
 "*Disclaimer: BeeWise provides basic educational financial information for students and is not a substitute for certified commercial financial advice.*"
 );
 };
