...
export const suggestedPrompts = [
  ...
  'How to manage my monthly allowance?'
];
...
export const chatbotKnowledge = [
  ...
  {
    id: 'overspending',
    keywords: ['overspending', 'impulse', 'control', 'stop spending', 'broke', 'waste', 'spend too much', 'spending too much', 'run out of money', 'empty account'],
  ...
  {
    id: 'savings_goals',
    keywords: ['goal', 'target', 'laptop', 'phone', 'plan a goal', 'save for', 'reach a goal', 'saving for'],
...
export const fallbackChatResponse = {
  ...
  response:
    'I may not have a specific guide on that exact phrase, but as your educational BudgetBee assistant, I can help you with:\n\n• **Needs vs. Wants classification**\n• **The 50/30/20 budgeting rule**\n• **Tips to prevent impulse buying**\n• **Calculating savings goals and timelines**\n• **Managing student allowances**\n\nTry clicking one of the suggested prompts below or ask a question about budgeting, saving, or student expenses!'
};
