...
export const SUPPORTED_LANGUAGES = [
  { id: 'en-GB', name: 'UK English', code: 'UK', speechLang: 'en-GB', dir: 'ltr' },
  { id: 'en-US', name: 'US English', code: 'US', speechLang: 'en-US', dir: 'ltr' },
  { id: 'en-IN', name: 'Indian (English/Hindi)', code: 'IN', speechLang: 'en-IN', dir: 'ltr' },
  { id: 'es-ES', name: 'Español', code: 'ES', speechLang: 'es-ES', dir: 'ltr' },
  { id: 'fr-FR', name: 'Français', code: 'FR', speechLang: 'fr-FR', dir: 'ltr' },
  { id: 'ar-SA', name: 'العربية (Arabic)', code: 'AR', speechLang: 'ar-SA', dir: 'rtl' }
];
